...
clear
dpkg -s python2  >/dev/null 2>&1 && echo "+++ settings up ++" &&
sleep 3 && run_menu || echo "something went wrong.Make sure you have run setup.sh or check your internet connection " && echo "please report any bugs or issues on GitHub"
